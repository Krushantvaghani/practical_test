                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Text(
                        "Granted Supplier",
                        style: TextStyle(color: Colors.deepPurple.shade500, fontSize: 15, fontWeight: FontWeight.w500),
                      ),
                    ),
                  ),
                ],
              ...
              children: [
                ...
                GetBuilder<HomeController>(
                  builder: (_) => ListView.builder(
                    itemCount: homeCtrl.representativeList.length,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  homeCtrl.representativeList["name"],
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 20,
                            ...
                            Checkbox(
                              ...
                              value: homeCtrl.representativeList[index],
                              onChanged: (bool? value) {
                                homeCtrl.representativeList.toggleChecked(index);
                              },
                            ),
                          ],
                        ),
